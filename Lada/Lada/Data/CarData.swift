...
let carsData: [Car] = [
    Car(title: "ВАЗ-2101", headline: "ВАЗ-2101 - самая первая модель, получившая народное название «копейка».", image: "ВАЗ-2101 (1970—1988)", gradientColors: [Color ("ColorOneLight"), Color("ColorOneDark")], description: "ВАЗ-2101 «Жигули» — советский заднеприводный легковой автомобиль малого класса с кузовом типа седан. Первая модель, выпущенная на Волжском автомобильном заводе. На базе ВАЗ-2101 было создано так называемое «классическое» семейство автомобилей ВАЗ, которое находилось на конвейере с 1970 до 17 сентября 2012 года.", features: ["2101", "Mеханическая 4-ступенчатая", "1,3 л", "69 л.с"]),
      ...
      Car(title: "ВАЗ-2103",
           headline: "ВАЗ-2103 (1972—1984) — модель с улучшенной комплектацией, отличавшаяся сдвоенными фарами и обилием хрома в отделке, на момент дебюта стала флагманом модельного ряда.",
      ...
      Car(title: "ВАЗ-2104",
           headline: "ВАЗ-2104 (1984—2012) — универсал на базе 2105, самая поздняя модель в гамме, известна на экспортных рынках как Kalinka и Signet.",
      ...
      Car(title: "ВАЗ-2105",
           headline: "ВАЗ-2105 (1980—2010) — первая модель с прямоугольными фарами, экстерьером и интерьером нового дизайна, известна на экспортных рынках как Riva, Nova, Laika и Clasico.",
    ...
    Car(title: "ВАЗ-2106",
         headline: "ВАЗ-2106 (1976—2006) — усовершенствованная версия модели 2103, с меньшим числом хромированных деталей в отделке, на момент дебюта стала флагманом модельного ряда.",
    ...
    Car(title: "ВАЗ-2107",
         headline: "ВАЗ-2107 (1982—2014) — люксовая версия «пятёрки», известная на экспортных рынках как Riva, Nova и Signet, на момент дебюта стала флагманом модельного ряда.",
